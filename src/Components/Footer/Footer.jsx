...
const Footer = () => {
  return (
    <div className="my-bg rounded-t-2xl">
      <footer className="footer sm:footer-horizontal w-11/12 mx-auto text-neutral-content p-10">
        ...
        <nav>
          ...
          <a className="link link-hover flex items-center gap-1">
            <Mail width={17} /> ihaveawonderfull@gamil.com
          </a>
          <a className="link link-hover flex items-center gap-1">
            <Phone width={17} /> 01621807642
          </a>
        </nav>
        <nav>
          <h6 className="footer-title flex items-center gap-1"><Link2 /> Social links</h6>
      ...
      <div className="p-6 my-bg">
        <p className="text-center text-gray-400">© AssetsPro • Secure Asset Management - 2025</p>
      </div>
    </div>
  );
};
